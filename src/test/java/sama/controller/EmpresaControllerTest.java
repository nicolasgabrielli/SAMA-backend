...
class EmpresaControllerTest {
    ...
    void testActualizarEmpresa() throws Exception {
        ...
        when(empresaService.save(Mockito.any())).thenReturn(empresa);
    ...
    void testEliminarEmpresa2() throws Exception {
        // Arrange
        when(empresaService.save(Mockito.any())).thenReturn(null);
    ...
    void testObtenerEmpresa() throws Exception {
        ...
        empresa.setTelefono("Telefono");
        empresa.setTipoSociedad("Tipo Sociedad");
        when(empresaService.findById(Mockito.any())).thenReturn(empresa);
    ...
    void testObtenerEmpresa2() throws Exception {
        // Arrange
        when(empresaService.findById(Mockito.any())).thenReturn(new Empresa());
