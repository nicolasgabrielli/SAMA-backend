...
class ReporteServiceTest {
    ...
    void testFindAll() {
        // Arrange
        when(reporteRepository.findAllByEmpresaId(Mockito.any())).thenReturn(new ArrayList<>());
    ...
    void testFindAll2() {
        ...
        when(reporteRepository.findAllByEmpresaId(Mockito.any())).thenReturn(reporteList);
    ...
    void testSave() {
        ...
        reporte.setId("42");
        reporte.setTitulo("Titulo");
        when(reporteRepository.save(Mockito.any())).thenReturn(reporte);
    ...
    void testFindById() {
        ...
        when(reporteRepository.findById(Mockito.any())).thenReturn(ofResult);
    ...
    void testUpdate() {
        ...
        when(reporteRepository.findById(Mockito.any())).thenReturn(emptyResult);
    ...
    void testUpdate2() {
        ...
        doNothing().when(reporte).setCategorias(Mockito.any());
        doNothing().when(reporte).setEmpresaId(Mockito.any());
        doNothing().when(reporte).setEstado(Mockito.any());
        doNothing().when(reporte).setFechaCreacion(Mockito.any());
        doNothing().when(reporte).setFechaModificacion(Mockito.any());
        doNothing().when(reporte).setId(Mockito.any());
        doNothing().when(reporte).setTitulo(Mockito.any());
        reporte.setAnio(1);
        reporte.setCategorias(new ArrayList<>());
        reporte.setEmpresaId("42");
        reporte.setEstado("Estado");
        ...
        reporte2.setId("42");
        reporte2.setTitulo("Titulo");
        when(reporteRepository.save(Mockito.any())).thenReturn(reporte2);
        when(reporteRepository.findById(Mockito.any())).thenReturn(ofResult);
    ...
    void testUpdate3() {
        ...
        reporte.setTitulo("Titulo");
        Optional<Reporte> ofResult = Optional.of(reporte);
        when(reporteRepository.save(Mockito.any())).thenThrow(new RuntimeException("foo"));
        when(reporteRepository.findById(Mockito.any())).thenReturn(ofResult);
    ...
    void testDelete() {
        // Arrange
        doNothing().when(reporteRepository).deleteById(Mockito.any());
    ...
    void testCrearPreset2() {
        ...
        reporte.setTitulo("Titulo");
        Optional<Reporte> ofResult = Optional.of(reporte);
        when(reporteRepository.save(Mockito.any())).thenThrow(new RuntimeException("Preset"));
        when(reporteRepository.findById(Mockito.any())).thenReturn(ofResult);
    ...
    void testCrearPreset3() {
        ...
        doNothing().when(reporte2).setCategorias(Mockito.any());
        doNothing().when(reporte2).setEmpresaId(Mockito.any());
        doNothing().when(reporte2).setEstado(Mockito.any());
        doNothing().when(reporte2).setFechaCreacion(Mockito.any());
        doNothing().when(reporte2).setFechaModificacion(Mockito.any());
        doNothing().when(reporte2).setId(Mockito.any());
        doNothing().when(reporte2).setTitulo(Mockito.any());
        reporte2.setAnio(1);
        reporte2.setCategorias(new ArrayList<>());
        reporte2.setEmpresaId("42");
        reporte2.setEstado("Estado");
        ...
        when(reporteRepository.save(Mockito.any())).thenReturn(reporte3);
        when(reporteRepository.findById(Mockito.any())).thenReturn(ofResult);
    ...
    void testCrearPreset4() {
        ...
        verify(reporte2).setEmpresaId("42");
        verify(reporte).setEmpresaId("42");
        verify(reporte, atLeast(1)).setEstado(Mockito.any());
        verify(reporte2).setEstado("Estado");
        verify(reporte2).setFechaCreacion(isA(Date.class));
        verify(reporte, atLeast(1)).setFechaCreacion(isA(Date.class));
        verify(reporte2).setFechaModificacion(isA(Date.class));
        verify(reporte, atLeast(1)).setFechaModificacion(Mockito.any());
        verify(reporte2).setId("42");
        verify(reporte).setId("42");
        verify(reporte, atLeast(1)).setTitulo(Mockito.any());
        verify(reporte2).setTitulo("Titulo");
    ...
    void testFindAllPresets() {
        // Arrange
        when(reporteRepository.findAllByEstado(Mockito.any())).thenReturn(new ArrayList<>());
    ...
    void testFindAllPresets2() {
        ...
        ArrayList<Reporte> reporteList = new ArrayList<>();
        reporteList.add(reporte);
        when(reporteRepository.findAllByEstado(Mockito.any())).thenReturn(reporteList);
    ...
    void testFindAllPresets3() {
        // Arrange
        when(reporteRepository.findAllByEstado(Mockito.any())).thenThrow(new RuntimeException("Preset"));
