...
class ReporteServiceTest {
    ...
    void testUpdate2() {
        ...
        verify(reporte).setEmpresaId(eq("42"));
        verify(reporte).setEstado(eq("Estado"));
        verify(reporte).setFechaCreacion(isA(Date.class));
        verify(reporte).setFechaModificacion(isA(Date.class));
        verify(reporte).setId(eq("42"));
        verify(reporte).setTitulo(eq("Titulo"));
    ...
    void testCrearPreset3() {
        ...
        verify(reporte2).setAnio(eq(1));
        verify(reporte2).setCategorias(isA(List.class));
        verify(reporte2).setEmpresaId(eq("42"));
        verify(reporte2).setEstado(eq("Estado"));
        verify(reporte2).setFechaCreacion(isA(Date.class));
        verify(reporte2).setFechaModificacion(isA(Date.class));
        verify(reporte2).setId(eq("42"));
        verify(reporte2).setTitulo(eq("Titulo"));
    }
    ...
    void testFindAllPresets() {
        ...
        // Assert
        verify(reporteRepository).findAllByEstado(eq("Preset"));
    ...
    void testFindAllPresets4() {
        ...
        verify(reporte).setCategorias(isA(List.class));
        verify(reporte).setEmpresaId(eq("42"));
        verify(reporte).setEstado(eq("Preset"));
        verify(reporte).setFechaCreacion(isA(Date.class));
        verify(reporte).setFechaModificacion(isA(Date.class));
        verify(reporte).setId(eq("42"));
        verify(reporte).setTitulo(eq("Preset"));
        verify(reporteRepository).findAllByEstado(eq("Preset"));
        assertEquals(1, actualFindAllPresetsResult.size());
    }
