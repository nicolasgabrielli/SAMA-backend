...
class UsuarioControllerTest {
    ...
    void testDeleteUser() throws Exception {
        // Arrange
        when(usuarioService.deleteById(Mockito.any())).thenReturn(1);
    ...
    void testDeleteUser2() throws Exception {
        // Arrange
        when(usuarioService.deleteById(Mockito.any())).thenReturn(0);
    ...
    void testObtenerUsuarioPorId() throws Exception {
        ...
        when(usuarioService.obtenerUsuarioPorId(Mockito.any())).thenReturn(usuario);
    ...
    void testObtenerUsuarioPorId2() throws Exception {
        // Arrange
        when(usuarioService.obtenerUsuarioPorId(Mockito.any())).thenReturn(new Usuario());
    ...
    void testSaveUser() throws Exception {
        ...
        usuario.setNombre("Nombre");
        usuario.setRol("Rol");
        when(usuarioService.save(Mockito.any())).thenReturn(usuario);
